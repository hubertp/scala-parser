...
// Copy-paste from the scala-records compatibility trick.
// Available at:
// https://github.com/scala-records/scala-records/blob/master/core/src/main/scala/records/Compat210.scala
